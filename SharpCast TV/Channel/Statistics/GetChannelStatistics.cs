...
namespace QuickType
{
    ...
    /*public partial class GetChannelStatistics
    {
        public static GetChannelStatistics FromJson(string json) => JsonConvert.DeserializeObject<GetChannelStatistics>(json, QuickType.Converter.Settings);
    }

    public static class Serialize
    {
        public static string ToJson(this GetChannelStatistics self) => JsonConvert.SerializeObject(self, QuickType.Converter.Settings);
    }*/
}
